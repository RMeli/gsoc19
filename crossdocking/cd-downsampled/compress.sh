...
#for pocket in AOFB
do
    gzip -f carlos_cd/${pocket}/PDB_Structures/*_default_ensemble_none_flexdist3.5*.pdb
    gzip -f carlos_cd/${pocket}/PDB_Structures/*_default_ensemble_none_flexdist3.5*.sdf
done